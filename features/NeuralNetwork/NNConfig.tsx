...
interface NNConfigFormProps {
  config: NNConfig;
  onConfigChange: (newConfig: Partial<NNConfig>) => void;
}
...
export const NNConfigForm: React.FC<NNConfigFormProps> = ({ config, onConfigChange }) => {
  ...
  // For simplicity, only one hidden layer is configurable here.
  // To add more, you'd need dynamic form generation.
  ...
  return (
    <div className="space-y-4 mb-6">
      ...
      {/* Add controls for more hidden layers if needed */}
    </div>
  );
};
