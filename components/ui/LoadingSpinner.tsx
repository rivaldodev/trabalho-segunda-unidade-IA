...
export const LoadingSpinner: React.FC<LoadingSpinnerProps> = ({ size = 'md', message }) => {
  ...
  if (size === 'lg') spinnerSizeClass = 'h-20 w-20';

  return (
    <div className="flex flex-col items-center justify-center py-8">
      <svg className={`animate-spin text-primary ${spinnerSizeClass}`} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
